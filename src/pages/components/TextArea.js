...
import EditorExpress from "./EditorExpress"
// 获取焦点位置
...
class TextArea extends Component {
    ...
    render () {
        const { visibleBottom, visibleNumber, visibleExpress, placeholder, isRandom, id, disabled, value } = this.props
            ...
            <div className={styles.box} style={boxStyle}>
                ...
                {BottomVisible === "visible" && (
                    <div className={styles.betweenItem}>
                        ...
                        {isRandom && <Button size="small" type="primary" onClick={() => this.selectExpress("#随机表情#")}>添加随机表情</Button>}
                        {isRandom && <EditorExpress></EditorExpress>}
